...
srednia = sum(temperatury)/len(temperatury)             # Czemu przez len temperatury jak jest przez liczbę dni? W te fx brak takiego argumentu chyba.
...
def najcieplejszy_dzien() -> tuple[str, float]:
    ...
    max_temp_index = temperatury.index(max_temp)
    return DNI_TYGODNIA[max_temp_index], max_temp
